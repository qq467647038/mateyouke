...
class Comment extends Common{
    ...
    public function checked(){
        if(request()->isPost()){
            if(input('post.id')){
                ...
                $comments = Db::name('comment')->where('id',$com_id)->where('shop_id',$shop_id)->field('id')->find();
                if($comments){
    ...
    public function deletecp(){
        ...
        if(!empty($id) && !is_array($id)){
            if(input('com_id')){
                $com_id = input('com_id');
                $coms = Db::name('comment')->where('id',$com_id)->where('shop_id',$shop_id)->field('id')->find();
                if($coms){
    ...
    public function delete(){
        ...
        $id = input('id');
        if(!empty($id) && !is_array($id)){
            $coms = Db::name('comment')->where('id',$id)->where('shop_id',$shop_id)->field('id')->find();
            if($coms){
