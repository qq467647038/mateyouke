...
class Kcyj extends Common{
    public function lst(){
        ...
        $list = Db::name('product')->alias('a')->field('a.id,a.goods_id,a.goods_number,a.goods_attr,b.goods_name')->join('sp_goods b','a.goods_id = b.id','INNER')->where('a.shop_id',$shop_id)->where('a.goods_number','elt',$product_zhi)->where('b.onsale',1)->paginate(25);
        $page = $list->render();
