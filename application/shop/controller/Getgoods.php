...
class Getgoods extends Common{
    ...
    public function lst(){
        ...
        if(input('goods_id')){
            ...
            $goods_id = '';
            if(cookie('get_goods_id')){
                cookie('get_goods_id',null);
            }
        }
    ...
    public function search(){
        ...
        if(input('post.goods_id') != ''){
            cookie('get_goods_id',input('post.goods_id'),3600);
        }
        ...
        if(cookie('get_goods_id')){
            $where['a.id'] = array('not in',cookie('get_goods_id'));
        }
