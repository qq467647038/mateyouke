...
// echo $ahead_time;exit;
        ...
        for ($i=0; $i<count($list); $i++){
            ...
            $list[$i]['time_countdown'] = $start_time+$ahead_time - time();
        }
            ...
            if($result['status'] == 200){
                ...
                if(is_null($info)){
                    ...
                    try{
                            ...
                            if($profit > 0){
                                $res = Db::name('contract_record_wallet')->where('user_id', $info['sale_id'])->inc('cumulative_earnings', $profit)->update();
                    ...
                    if ($info) {
                        ...
                        if (md5($post['paypwd']) == $paypwd) {
                            ...
                            try{
                                ...
                                $profit = $wine_order_saler_info['sale_amount'] - $wine_order_saler_info['buy_amount'];
                                if(!$wine_order_saler_info['buy_amount']){
                                    $profit = 0;
                                }
                                if($profit > 0){
